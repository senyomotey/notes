...
class LaunchScreenMobile extends StatefulWidget {
  ...
  @override
  State<LaunchScreenMobile> createState() => LaunchScreenMobileState();
}

class LaunchScreenMobileState extends State<LaunchScreenMobile> with TickerProviderStateMixin {

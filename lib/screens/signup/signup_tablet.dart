...
class SignUpScreenTablet extends StatefulWidget {
  const SignUpScreenTablet({Key? key}) : super(key: key);

  @override
  State<SignUpScreenTablet> createState() => SignUpScreenTabletState();
}

class SignUpScreenTabletState extends State<SignUpScreenTablet> with TickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
  }

...
class LoginScreenDesktopState extends State<LoginScreenDesktop> with TickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            Navigator.pushReplacementNamed(context, RouteNames.signUpScreenRoute);
                          },
                          child: Text(

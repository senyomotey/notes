...
class InfoScreenDesktop extends StatefulWidget {
  const InfoScreenDesktop({Key? key}) : super(key: key);

  @override
  State<InfoScreenDesktop> createState() => InfoScreenDesktopState();
}

class InfoScreenDesktopState extends State<InfoScreenDesktop> with TickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
  }
